...
gulp.task('variable:build', function() {
    gulp.src(path.src.variable)
        .pipe(gulp.dest(path.build.variable))
});
...
gulp.task('watch', function(){
    ...
    watch([path.watch.variable], function(event, cb) {
        gulp.start('variable:build');
    });
});
